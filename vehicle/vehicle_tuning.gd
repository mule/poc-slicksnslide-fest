...
@export_range(0.0, 50000.0, 10.0) var engine_force: float = 17000.0
@export_range(0.0, 50000.0, 10.0) var reverse_force: float = 6500.0
@export_range(0.0, 50000.0, 10.0) var brake_force: float = 17000.0
@export_range(0.0, 10.0, 0.01) var rolling_drag: float = 0.32
@export_range(0.0, 1.0, 0.001) var aerodynamic_drag: float = 0.012
@export_range(0.0, 100.0, 0.5) var max_safe_speed: float = 48.0
@export_range(0.0, 20.0, 0.1) var stop_speed: float = 0.75
...
@export_range(0.0, 20.0, 0.1) var steering_full_speed: float = 18.0
@export_range(0.0, 10.0, 0.01) var max_angular_speed: float = 2.6
@export_range(0.0, 50.0, 0.05) var lateral_grip: float = 5.5
@export_range(0.0, 100.0, 0.1) var lateral_grip_acceleration: float = 24.0
...
@export_range(0.0, 20.0, 0.1) var low_speed_stabilization: float = 4.0
