...
Terrain catalog version 1 is a three-octave value-noise field (amplitude 40 px, base wavelength
3000 px, persistence 0.25, lacunarity 2) covering the whole play area, drawn from its own
`terrain` domain seed after road acceptance and ramp placement, with the ramps summed onto it. The
field never leaves ±52.5 px (4.2 m); its curvature bound of 1.875 × 10⁻⁴ per px sits under the
car's lift-off threshold at `max_safe_speed` (2.994 × 10⁻⁴) with a 1.60× margin, and no drive on
bare terrain has lifted the car off. Every seed in 0-19 spans at least 74 px of relief and carries
a SHA-256 terrain fingerprint over a 250 px grid of its play area, stable across regeneration and
distinct across seeds; the column is in the table below. Elevation is drawn as tint and light from
the same height map the car drives on, off-track objects stand on it, and since #52 every shadow is
anchored to the body it belongs to. Scripted laps of seeds 0, 4 and 9 through the production
session complete in 69.6, 85.2 and 86.8 s with every flight from a ramp and every landing on the
road; the raw ledger, drive trace and stills are under
[`docs/evidence/terrain/`](evidence/terrain/). See [The terrain field](terrain.md) for the
contract, the physics bounds, the limitations (the car's low-layer mask still compares absolute
height; shadows in hollows nearly vanish) and every mutation flag.

Android #23 and Steam Deck #7 have no terrain observation yet: their reports must record how the
hills read on hardware, whether a climb or descent felt unfair, and one ramp taken on shaped
ground, in addition to the ramp count and completed jump already required below.
...
object hash on any seed. The terrain fingerprint column was added by epic #46
from `tests/capture_terrain_evidence.gd`, which also re-checks the other three
columns against the checked-in height-channel ledger on every run: adding the
terrain moved none of them (20 of 20 seeds). The road hashes
...
object fingerprint repeats for the same seed, and the terrain capture that each
terrain fingerprint repeats and is distinct across seeds.

| Seed | Road fingerprint | Object fingerprint | Height fingerprint | Terrain fingerprint |
| ---: | --- | --- | --- | --- |
| 0 | `c473c35414d6ee31c9abada0c4d5fe4856997f137ca8d7dd6223a45da29bf55f` | `5f587a1b70ce3300729a390f555f277329c0d3e2e385891396868da5470bac88` | `6831dab8217f2bd2a407a9d2caf3cb7946c1671b3b3947d6b98ebde1b8537571`  `03f45d13053809507e6cfac470a1ff4b3d7ddf8a4d18eef7bd380599ccbf8885` |
| 1 | `b4b5a88a8be258e58c43567bb2e1ffc9364f21c98bae38ee92e0a087de9fa90e` | `a6e2ba9fb9a8ac7f43b29874878529b37cb3f368bcd382e2a7346760e895a9f7` | `9f1c710cdeeb30dc42a32d8e1ec301f58be9773e9a6a2b17e9b9c2ebc4a31a9c`  `971e18b00e98a00d6b4628dff2896f193ce5d86e586c7a19e2970d99c8a87e87` |
| 2 | `d1e5d0df9651e041374342582d1cccf79193fe8ecb95796baac1eb19217bd7ea` | `308f0795be1df084a297b4e74971d17be10297420df51c6297fbe28606594d28` | `605602a82d56acdeca82f15c3a21fb5027badf331afd279d841561dd15ab6578`  `ea0c7206675f60c2115bc10a2bf599acef83114b9f5b9e5193fe0a2962f48243` |
| 3 | `a1e4ab9b4425050a266ac40d2bb958b99d303303192c241c02b0822912ed078d` | `8222001966fe85a9b0df8c1abdc5e4172586c18b702ea3891fce5309e8c2a0d9` | `be4eeef9dc1a7bfd33a079936574ee5f9ec19bf5203b4b9a4d31580560a0adae`  `472aa1213308ccee37eb1366b1a3f672a7efc7360a151fa3372e6363f4df2225` |
| 12 | `5331af0ca10b06d73cb47223caf72bebfa0c87c53df04951a395c24e2646976f` | `8c9512f41ea4fcb539b6c2b5dbc1475b06cd274cbf243a8ce6272ac79df2f2e2` | `db6d8bdb4cd91b54f7ea631b3d62429d2dcdec18a26c918a5b201454b8b197ef`  `3d2d5a550bef4709121b6eb5a7fd443b89e776018343263962658df63b88a7f5` |
| 13 | `a3b44cf2ccee2206c308f0bdc1af8324e32767e59152061a174b887ad3db97a2` | `765febb166d37358cf41515ecebe5ac3aa314ff0f5136b83cf31455dd1458852` | `1b9690103b4c9e03cffa08c1d4e301edd31c79a72f8ab5c8dd5a34ab3939275c`  `481b26e5b6316bb0a2ad98e43f65b6f9cbfae28d202026a9e386109a51171177` |
| 14 | `72af4a69dc7a4a8c5924348879c45258c9fd047fdcf325774a44ba025b781633` | `24b85a0a988cc5c7f76b9d74615e8c35d68f0d74bb323d89764b62b6a1233132` | `fee3ceaac918daf9740baba1976ca2e9d32471137f25cb714f0d90b81b5deff9`  `8792bc236c46a3611360cad3fcb1cfd4acda4e59c0bd65384c0f87184d1c7a95` |
| 15 | `3c2386bfa626521b3ba4996c2191cefb6902728d9c1ec80c9bd18b8a7c30fa34` | `6060ea3ec4be6e5684247648357331687cf19d318fb493c802608099d89fd622` | `9f18398c73c00acfe11f2ca007b629c974bb4210fb7859e431615a6a9a968818`  `ef12242db0b25a061999098cf19bcd5289a02b4f9fc3377bd8e499d418e00ab9` |
| 16 | `97458ea8106f57c08f45cc2f6d35611be28bd03e40dcc57431022e129a2d1bb9` | `2c7dbb2314d629d893c06757e9c960c155be26fb7dfcc6e95dcb3ac6751a2288` | `6352695a13800db1c3f94fa9356d7f009f9a36558314977ee07b099bc8999bc1`  `93dc52a69b19f896646c1f31e3a5b45172fb6bcbf1de90d2d6e490c9d6e2b556` |
| 17 | `497f951e560567f3ed51b523ded8761dbad88e94fa347124e56ece7911b60cf4` | `97198fba598f07593c8b9af43619979916abc23956b60e591203c57a5664e85f` | `6a2f187aada88834c671fd147c17de8dc93dbb0bfb9d864592600b03a35d8596`  `82cbc5ec4f3d167a205eede1d76a4d7bf0bc4c912f558e9664f5fa226fb94bb1` |
| 18 | `4018845b4baf9e1d3da8b49fc42d02b832771c952fb0616de956b13a150a4597` | `d3a77402e5dd1b77ac221b57f466b0ac1825934d022ea7318d42177b0cf3ffff` | `aa3f167e270c8cbbac0eb4b6881afb84e44b6f23fd64e8c4217333c6e29f1672`  `38aaf85dd1eb9ea591a4ee8de3f6108fa9c087e0c143de39b10f3edafa539a52` |
| 19 | `1ccbbd249025dfc5f5d8a05f60fa43933f023bd34cfa38d66d42d66bc066bbda` | `ee5073557e8b04df7f95c075a37edc7cbd1d00b731b2760c62a84c892afc3016` | `a173fe174f3a2ce3d1b93ca14827ed92af72d25f7e4e69c65357076f391d8af1`  `8b13fca574d45984d30191593b81a11c9dcd44c2cf44ee031afb989a5b261d9b` |
...
- Issue #23 is open: first check out the fixed behavior revision
  ...
  observed on Android hardware, and a terrain observation (how the hills read,
  whether any climb or descent felt unfair, one ramp taken on shaped ground),
  because none has been observed there either.
- Issue #7 is open: first check out the same final approved revision, export a
  ...
  same reason, and the same terrain observation.
